...
export const metadata: Metadata = {
  title: `ᐈ【Перетяжка кровати Киев】Mevaro|Бесплатная Доставка⚡${new Date().getFullYear()}`,
  description:
    '✅Перетяжка кровати. Цена|Киев✓【Замена механизмов и ремонт кровати】✓Гарантия 12 месяцев✓Работаем за Договором',
  keywords: ['перетяжка кровати', 'ремонт кровати Киев', 'оббивка кровати'],
  creator: 'Mevaro',
  publisher: 'Mevaro',
  openGraph: {
    title: `ᐈ【Перетяжка кровати Киев】Mevaro|Бесплатная Доставка⚡${new Date().getFullYear()}`,
  ...
  return (
    <html lang="en">
      <head>
              ...
              '@graph': [
                {
                  ...
                  name: `ᐈ【Перетяжка кровати Киев】Mevaro|Бесплатная Доставка⚡${new Date().getFullYear()}`,
                  isPartOf: {
                    '@id': 'https://mevaro.kiev.ua/',
                  },
        ...
        <link rel="canonical" href="https://mevaro.kiev.ua/ru/lijko" />
      </head>
