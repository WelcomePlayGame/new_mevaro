  ...
  return (
    ...
    >
      <h2 className={`${classes.container_h3}`}>
        Питання та відповіді по ремонту меблів
      </h2>
      <ol className={`${classes.container_ol}`}>
        ...
        >
          <details>
            <summary>
              <span itemProp="name">Що таке ремонт меблів?</span>
            </summary>
            <p
            ...
            >
              <span itemProp="text">
                Ремонт меблів — це процес оновлення м&apos;яких меблів, який
                включає ремонт каркасу, наповнювача чи ремонт механізмів. Це
        ...
        >
          <details>
            <summary>
              <span itemProp="name">Які переваги ремонт меблів?</span>
            </summary>
            <p
              className={`${classes.container_p}`}
              itemProp="acceptedAnswer"
            ...
            >
              <span itemProp="text">
                Ремонт меблів дозволяє заощадити кошти, адже це дешевше за
